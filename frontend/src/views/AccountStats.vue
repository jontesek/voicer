<template>
  <div class="content-page">
    ...
    <p>
      Check your statistics at <a href="https://aistudio.google.com/usage">Google AI Studio</a>:
      Select time range 1 day, choose one TTS model and check request count.
    </p>
    <p>
    ...
    <p>
      Check RPD value at
      <a href="https://ai.google.dev/gemini-api/docs/rate-limits#free-tier">rate limits docs</a> to
      confirm. Look for "Gemini 2.5 Flash Preview TTS".
    </p>
    <p>If you enable billing, you will enjoy higher limits and access to the Pro TTS model.</p>

    <h3>Estimated API usage</h3>
    <p>
      The app tracks each time you hit the Generate button. It should be the same as the number of
      requests to Gemini API.
    </p>
    <p>Request count since last reset ({{ localResetDtString }}): {{ requestCountSinceReset }}</p>
    <p>
      <strong>Remaining requests: {{ freeTierRequestPerDay - requestCountSinceReset }}</strong>
    </p>
